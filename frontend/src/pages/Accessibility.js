...
const AccessibilityStatement = ({
    ...
    return (
        <div style={styles.body} className="container">
            ...
            <p><a href="mailto:Information.systems@ed.ac.uk"
                  style={styles.link}>Information.systems@ed.ac.uk</a></p>
            ...
            <p>This website is partially compliant with the Web Content Accessibility Guidelines (WCAG) 2.2 AA
                standard,
                due to
            ...
            <ul>
                ...
                <li><a href="https://www.w3.org/TR/WCAG22/#non-text-content" style={styles.link}>1.1.1 - Non Text
                    Content</a></li>
            </ul>

            <ul>
                <li>The site has functionality issues in portrait mode on Android devices</li>
                <li><a href="https://www.w3.org/TR/WCAG22/#orientation" style={styles.link}>1.3.4 - Orientation</a>
                </li>
            </ul>

            <ul>
                <li>Some hyperlinks are conveyed with colour only</li>
                <li><a href="https://www.w3.org/TR/WCAG22/#use-of-color" style={styles.link}>1.4.1 - Use of
                    Colour</a>
                </li>
            ...
            <ul>
                ...
                <li><a href="https://www.w3.org/TR/WCAG22/#contrast-minimum" style={styles.link}>1.4.3 - Contrast
                    (Minimum)</a></li>

            </ul>

            <ul>
                <li>Some items are examples of text as an image and do not contain the appropriate alternative
                    text
                </li>
                <li><a href="https://www.w3.org/TR/WCAG22/#images-of-text" style={styles.link}>1.4.5 - Images of
                    Text</a></li>
            </ul>
            ...
            <ul>
                ...
                <li><a href="https://www.w3.org/TR/WCAG22/#bypass-blocks" style={styles.link}>2.4.1 - Bypass
                    Blocks</a>
                </li>
            </ul>
            <ul>
                <li>Some links do not contain meaningful hypertext to inform the user of their target location</li>
                <li><a href="https://www.w3.org/TR/WCAG22/#link-purpose-in-context" style={styles.link}>2.4.4 - Link
                    Purpose (In
                    Context)</a>
                </li>
            </ul>
            <ul>
                <li>Headings are not formatted correctly and some heading levels are missed, which affects screen
                    reader
                    software
                </li>
                <li><a href="https://www.w3.org/TR/WCAG22/#headings-and-labels" style={styles.link}>2.4.6 - Headings
                    and
                    Labels</a></li>
            </ul>
            <ul>
                <li>It is not always clear where you have tabbed to using a keyboard</li>
                <li><a href="https://www.w3.org/TR/WCAG22/#focus-visible" style={styles.link}>2.4.7 - Focus
                    Visible</a>
                </li>
            </ul>
            <ul>
            ...
            <ul>
                <li>Help such as contact us and the chat function are not located in the same place on every page.
                </li>
                <li><a href="https://www.w3.org/TR/WCAG22/#consistent-help" style={styles.link}>3.2.6 - Consistent
                    Help</a></li>
            </ul>
            <ul>
                <li>The website is not fully compatible with assistive software e.g. – using assistive software it
                    is
            ...
            <p>We will continue to address and make significant improvements to the accessibility issues
                highlighted.
            ...
            <p>
                ...
                adjustments are in place to make sure no user is disadvantaged. As changes are made, we will
                continue to
            ...
            <p>Since our initial report, we have undertaken more extensive manual testing with assistive software to
                get
                a better understanding of the accessibility issues on this website. This section will receive
                updates as
